//LTC2945 Test Code
//  original code http://www.kevindarrah.com/wiki/index.php?title=Power_Monitor
...
String ApiKey = "";  //put your ThingSpeak ApiKEY between the quotes
String path = "/update?key=" + ApiKey + "&field1=";  

const char* ssid = "";  //put your network ssid between the quotes
